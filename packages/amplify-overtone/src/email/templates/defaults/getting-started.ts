...
export const gettingStartedTemplate: TemplateDefinition = {
    ...
    <a href="${data["dashboardLink"]}" style="display:inline-block;padding:12px 24px;background:#e8734a;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;">Go to Dashboard</a>
        ...
        return `${greeting}
<p style="margin:0 0 16px;font-size:16px;color:#333;">Welcome to ${brand}! We're excited to have you on board.</p>
<p style="margin:0 0 16px;font-size:16px;color:#333;">You're all set and ready to get started. Explore the features and let us know if you have any questions.</p>
${ctaHtml}`;
    },
